...
var __defProp2, __getOwnPropNames, __name = (target, value) => __defProp2(target, "name", { value, configurable: true }), __commonJS = (cb, mod) => function __require() {
  return mod || (0, cb[__getOwnPropNames(cb)[0]])((mod = { exports: {} }).exports, mod), mod.exports;
}, __export2 = (target, all) => {
  for (var name in all)
    __defProp2(target, name, { get: all[name], enumerable: true });
}, require_util, utils_exports, check_error_exports, canElideFrames, AssertionError, ansiColors, styles, truncator = "…", getArrayName, isNaN, stringEscapeChars, escapeCharacters, hex = 16, unicodeLength = 4, getPromiseValue, promise_default, toStringTag, errorKeys, symbolsSupported, chaiInspect, nodeInspect = false, constructorMap, stringTagMap, baseTypesMap, inspectCustom, toString, config, MemoizeMap, deep_eql_default, fnLengthDesc, builtins, canSetPrototype, testFn, excludeNames, call, apply, isNaN2, flag2, functionTypes, should_exports, should, Should, used;
var init_chai = __esm(() => {
...
// index.ts
var { assert: assert2 } = await Promise.resolve().then(() => (init_chai(), exports_chai));
